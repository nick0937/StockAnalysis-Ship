...
import config as C
from lib import total_score, market_score, band_of, final_five
import market as MK
...
# ★ 2026-09-24 修：原本漏了 §9.2 B 組（strat_adj），改由 lib.final_five 統一組法。
for c in C.CODES:
    S[c] = final_five(S[c], IND["stocks"][c], MK.ENV_SCORE)[0]
